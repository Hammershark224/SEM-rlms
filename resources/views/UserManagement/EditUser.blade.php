        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form role="form" method="post" action="{{ route('user.update',$dataUser['user_ID']) }}" enctype="multipart/form-data">
                    {{csrf_field()}}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="username" value = "{{$dataUser->username}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="phone_num" value = "{{$dataUser->phone_num}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6" id="staffField" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="staff_ID" value = "{{$userData->staff_ID}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6" id="studentField" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="matric_ID" value = "{{$userData->matric_ID}}">
                                    </div>
                                </div>
